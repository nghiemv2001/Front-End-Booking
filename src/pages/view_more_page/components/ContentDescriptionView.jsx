...
import Dialog from './DialogCalendar';
  ...
  return (
    <div className="container_content_description_view">
      ...
      <div className="container_description_content_view">
        <p className="description_content_view">
          {displayedText}
        </p>
      </div>
      ...
      <div className="container_btn_ic">
        <button className="button_booking_view_more" onClick={OpenDialog} >Book Now</button>
        <img src={icArrRight} alt="icon arrow" />
      </div>
      <Dialog isOpen={isOpenDialog} onClose={CloseDialog} title="Restaurant Experience">
